...
const Nav = ({
	...
	const pageIndicatorOffsetWithDecoration = useMemo(() => 71 + pageIndicatorOffset - dragYOffset, [pageIndicatorOffset, dragYOffset]);
		...
		<>
			...
			<Container openOnMobile={openOnMobile}>
              ...
              <ChevronDown />
					...
					<Icons>
						<a href="https://twitter.com/quantumlytngld">
							<TwitterLogo />
						</a>
						<a href="https://github.com/quantumlytangled">
							<GitHubLogo />
						</a>
						<a href="https://keybase.io/quantumly">
							<KeyIcon />
						</a>
						<a href="https://www.linkedin.com/in/nejc-drobnic">
							<LinkedinLogo />
						</a>
					</Icons>
