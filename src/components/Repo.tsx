...
const Repo = ({ url, name, primaryLanguage, description }: { url: string; name: string; primaryLanguage: Language; description: string }) => {
	return (
		<A href={url} target="_blank" rel="noopener">
			<Container>
				...
				<Column forceWidth={150}>
					<h5>language</h5>
					<p>
						{primaryLanguage} <LanguageColorBlip color={determineLanguageColor(primaryLanguage)} />
					</p>
				</Column>
				<Column noBorder>
					<h5>description</h5>
